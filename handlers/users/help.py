...
ADDITIONAL = f"Команда {hcode('/keyboard_gen')} присылает в клавиатуру, а при нажатии на её кнопку 'Прислать инлайн' " \
             "присылается инлайн клавиатура для генерации (попробуй!). \n" \
